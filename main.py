# توضیح: این فایل همه چیز رو شامل می‌شه: منطق بات، دکمه‌ها، دیتابیس MongoDB و قرعه‌کشی
...
# تنظیمات
TOKEN = os.getenv("TELEGRAM_TOKEN", "7864606782:AAEj5EH679g95P0sK0ZI1xHZjDWil_6wGkI")
MONGO_URI = os.getenv("MONGO_URI", "mongodb+srv://usef7400:josepH139900@@cluster0.ayjig.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
WALLET_ADDRESS = "UQAZEfdfeu-hjMZK-GsjpwAGJxPugS3MnHN6LlmhpKgk-iLd"  # آدرس کیف‌پول تو
ADMIN_ID = "7836825805"  # آیدی تلگرام تو
...
# توضیح: توابع کمکی برای مدیریت دیتابیس
...
# توضیح: تابع بررسی عضویت در کانال‌ها
...
# توضیح: مدیریت تراکنش‌ها و قرعه‌کشی
...
def run_lottery(bot):
    ...
    prize_per_winner = (500 * 0.8) / 10  # 80% بین 10 نفر
    admin_share = 500 * 0.2  # 20% برای شما

    # اطلاع‌رسانی به برندگان
    for winner in winners:
        bot.send_message(
            winner["user_id"],
            f"Congratulations! You won {prize_per_winner} TON in the lottery!"
        )
    ...
    bot.send_message(
        ...
        f"Prize per winner: {prize_per_winner} TON\nAdmin share: {admin_share} TON"
    )
