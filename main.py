...
import random
from urllib.parse import quote_plus  # برای کدگذاری رمز عبور

# تنظیمات
TOKEN = os.getenv("TELEGRAM_TOKEN")
# کدگذاری دستی نام کاربری و رمز عبور برای MongoDB
username = "usef7400"
password = quote_plus("josepH139900@@")  # رمز عبور با @ به %40 تبدیل می‌شه
MONGO_URI = os.getenv("MONGO_URI", f"mongodb+srv://{username}:{password}@cluster0.ayjig.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
