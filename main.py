...
import random
import logging
from tonsdk import TonClient, Address
...
ADMIN_ID = "7836825805"
SUPPORT_USERNAME = "@MyTonCobot"  # نام کاربری ربات شما
TON_API_URL = "https://toncenter.com/api/v2/jsonRPC"
TON_API_KEY = "13fa660adb77d2437dfaf8afc689f336cc5de33f3b71c08c851fb0b36e8dea97"  # کلید API شما
...
# اتصال به TON با کلید API شما
ton_client = TonClient(TON_API_URL, api_key=TON_API_KEY)
...
def verify_transaction(tx_hash, expected_amount):
    try:
        tx = ton_client.get_transaction(Address(WALLET_ADDRESS), tx_hash)
        if tx and tx["amount"] == expected_amount * 10**9 and tx["destination"] == WALLET_ADDRESS:  # TON به نانوTON
            return True
        return False
